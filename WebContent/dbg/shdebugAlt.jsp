...
if (request.getParameter("btClear") !=null)
   {
     sys.clearDbgAreaAlt();
     response.sendRedirect("shdebugAlt.jsp");
   }
...
<body onload="go()" style="font-family: Tahoma; font-size: 10pt; font-weight: bold" bgcolor="#000000" text="#00FF00" topmargin="0" leftmargin="0" vlink="#0000FF">
<table>
<%=sys.getDbgAreaAlt()%>
</table>
<form method="POST">
