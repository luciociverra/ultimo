  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="carousel-container" id="galleryBody">
      ...
      <!-- Carousel -->
      <div id="imageCarousel" class="carousel slide d-none" data-bs-ride="carousel" style="border:2px solid cyan">
        ...
        <div class="carousel-inner" id="carouselInner" style="border:2px solid red">
      ...
      function loadImages() {
        ...
        axios.get('slideservlet')
          .then(response => {
            ...
            log("loadImages len:"+images.length);
            if (images.length === 0) {   // Nessuna immagine trovata
      ...
      function generateCarouselContent() {
        ...
        images.forEach((image, index) => {
          ...
          slide.innerHTML = '<button class="zoom-btn" data-image-id="'+image.id+'"><i class="fas fa-search-plus"></i> Zoom</button>'+
            '<img src="<%=basePath%>getimmagine?id='+image.id+'" class="d-block" data-image-id="'+image.id+'">'+
            '<div class="carousel-caption d-none d-md-block"><h5>'+image.titolo+'</h5></div>';
          log("Carousel aggiunta:"+image.id);
      ...
      function setupZoomFunctionality() {
        ...
        document.querySelectorAll('.carousel-item img, .zoom-btn').forEach(element => {
          element.addEventListener('click', function() {
            ...
            document.getElementById('galleryBody').style.overflow = 'hidden';
          });
        });
        ...
        zoomClose.addEventListener('click', function() {
          ...
          document.getElementById('galleryBody').style.overflow = 'auto';
        });
